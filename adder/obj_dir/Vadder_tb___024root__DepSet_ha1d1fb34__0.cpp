...
VL_INLINE_OPT VlCoroutine Vadder_tb___024root___eval_initial__TOP__Vtiming__0(Vadder_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.adder_tb__DOT__a = 0U;
    vlSelfRef.adder_tb__DOT__b = 0U;
    co_await vlSelfRef.__VdlySched.delay(2ULL, nullptr, 
                                         "adder_tb.v", 
                                         28);
    vlSelfRef.adder_tb__DOT__a = 1U;
    vlSelfRef.adder_tb__DOT__b = 0U;
    co_await vlSelfRef.__VdlySched.delay(2ULL, nullptr, 
                                         "adder_tb.v", 
                                         31);
    vlSelfRef.adder_tb__DOT__a = 1U;
    vlSelfRef.adder_tb__DOT__b = 1U;
    co_await vlSelfRef.__VdlySched.delay(2ULL, nullptr, 
                                         "adder_tb.v", 
                                         34);
    vlSelfRef.adder_tb__DOT__a = 0U;
...
#endif
            VL_FATAL_MT("adder_tb.v", 5, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("adder_tb.v", 5, "", "Active region did not converge.");
            }
