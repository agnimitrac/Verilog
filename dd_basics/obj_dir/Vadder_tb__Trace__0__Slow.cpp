...
VL_ATTR_COLD void Vadder_tb___024root__trace_init_sub__TOP__0(Vadder_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+2,0,"e",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+3,0,"f",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+4,0,"g",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("half2_adder", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vadder_tb___024root__trace_full_0_sub_0(Vadder_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelfRef.adder_tb__DOT__d));
    bufp->fullBit(oldp+2,(vlSelfRef.adder_tb__DOT__e));
    bufp->fullBit(oldp+3,(((IData)(vlSelfRef.adder_tb__DOT__d) 
                           ^ (IData)(vlSelfRef.adder_tb__DOT__e))));
    bufp->fullBit(oldp+4,(((IData)(vlSelfRef.adder_tb__DOT__d) 
                           & (IData)(vlSelfRef.adder_tb__DOT__e))));
}
