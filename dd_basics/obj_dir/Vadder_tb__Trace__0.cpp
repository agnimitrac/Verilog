...
void Vadder_tb___024root__trace_chg_0_sub_0(Vadder_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgBit(oldp+0,(vlSelfRef.adder_tb__DOT__d));
    bufp->chgBit(oldp+1,(vlSelfRef.adder_tb__DOT__e));
    bufp->chgBit(oldp+2,(((IData)(vlSelfRef.adder_tb__DOT__d) 
                          ^ (IData)(vlSelfRef.adder_tb__DOT__e))));
    bufp->chgBit(oldp+3,(((IData)(vlSelfRef.adder_tb__DOT__d) 
                          & (IData)(vlSelfRef.adder_tb__DOT__e))));
}
